...
definition(
    ...
    author: "Joel Wetzel",
    description: "An app for Hubitat to put rooms to sleep. It does many of the same actions as motion lighting, but it has a different philosophy. It's centered on the idea that at night, rooms should 'relax' to a dimmed state and then off, and motion can wake them up.",
    category: "Lighting",
	iconUrl: "",
    iconX2Url: "",
    iconX3Url: "")
    ...
    dynamicPage(name: "mainPage") {
		...
		if (state.appInstalled == 'COMPLETE') {
			section(getFormat("title", "${app.label}")) {
  			...
  			section("<b>Sleepy Rooms:</b>") {
				app(name: "anyOpenApp", appName: "Sleepy Room", namespace: "joelwetzel", title: "<b>Add a sleepy room</b>", multiple: true)
			}
