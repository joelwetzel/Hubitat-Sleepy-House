...
class BasicTests extends IntegrationAppSpecification {
    ...
    void "initialize() subscribes to events"() {
        ...
        1 * appExecutor.subscribe(switchFixtures, 'switch', 'switchActivityHandler')
        1 * appExecutor.subscribe(dimmerFixtures, 'switch', 'switchActivityHandler')
    ...
    void "initialize() sets state"() {
        ...
        then:
        appState.lastActivityTime instanceof Date
    }
}
