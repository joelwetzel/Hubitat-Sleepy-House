...
class CanSleepTests extends IntegrationAppSpecification {
    ...
    def "motion activity will not delay sleep if motionActivityKeepsAwake == false"() {
        given:
        def testTime = appScript.timeToday("2020-02-24T02:00:00-0600")
        appScript.motionActivityKeepsAwake = false
    ...
    def "switch activity will not delay sleep if switchActivityKeepsAwake == false"() {
        given:
        def testTime = appScript.timeToday("2020-02-24T02:00:00-0600")
        appScript.switchActivityKeepsAwake = false
    ...
    def "dimmer activity will not delay sleep if dimmerActivityKeepsAwake == false"() {
        given:
        def testTime = appScript.timeToday("2020-02-24T02:00:00-0600")
        appScript.dimmerActivityKeepsAwake = false
