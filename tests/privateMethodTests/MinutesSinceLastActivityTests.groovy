...
*/
class MinutesSinceLastActivityTests extends IntegrationAppSpecification {
    ...
    def "motion activity"() {
        ...
        then:
        appScript.calculateMinutesSinceLastActivity() == 0

        when:
        TimeKeeper.advanceMinutes(1)

        then:
        appScript.calculateMinutesSinceLastActivity() == 1

        when:
        TimeKeeper.advanceMinutes(4)

        then:
        appScript.calculateMinutesSinceLastActivity() == 5
    }
    ...
    def "verify that calculateMinutesBetweenDates works during the day"() {
        given:
        def date1 = appScript.toDateTime("2020-02-24T05:30:00-0600")
        def date2 = appScript.toDateTime("2020-02-24T06:15:00-0600")

        when:
        def result = appScript.calculateMinutesBetweenDates(date1, date2)

        then:
        result == 45
    }

    def "verify that calculateMinutesBetweenDates gives zero if dates are out of order"() {
        given:
        def date1 = appScript.toDateTime("2020-02-24T05:30:00-0600")
        def date2 = appScript.toDateTime("2020-02-24T02:30:00-0600")
    ...
    def "verify that calculateMinutesBetweenDates gives zero if dates are identical"() {
        given:
        def date1 = appScript.toDateTime("2020-02-24T05:30:00-0600")
        def date2 = date1
    ...
    def "verify that calculateMinutesBetweenDates works for spans that cross midnight"() {
        given:
        def date1 = appScript.toDateTime("2020-02-24T22:30:00-0600")
        def date2 = appScript.toDateTime("2020-02-25T01:00:00-0600")
